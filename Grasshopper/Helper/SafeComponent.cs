...
namespace ScriptParasite.Helper;

public abstract class SafeComponent : GH_Component
{
    protected SafeComponent(string name, string nickname, string description, string category, string subCategory) : base(name, nickname, description, category, subCategory)
    {
    }
